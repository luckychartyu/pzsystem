<template>
    ...
    <div class="btns">
        <el-button :icon="Plus" @click="open(null)" size="small">新增</el-button>
        <el-popconfirm
...
import {phonoList,companion,companionList,deleteCompanion} from '../../../api'
 ...
 const handleSizeChange = (val) => {
  ...
  const confirmEvent = () => {
    ...
    if(!selectTableData.value.length){
        return ElMessage.warning('请选择至少一个数据')
    }
